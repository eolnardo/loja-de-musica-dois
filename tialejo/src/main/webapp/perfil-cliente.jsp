            ...
            <form action="/criar-cliente" method="post">
              ...
              <div class="input-group">
                ...
                <div class="input-box">
                  ...
                  <input type="text" id="enderecoEntrega" name="enderecoEntrega" value="${cliente.enderecoEntrega}" readonly><br><br>
                </div>
                <div class="input-box">
                ...
                <div class="input-box">
                  ...
                  <input type="text" id="cpf" name="cpf" value="${cliente.cpf}" maxlength="14" readonly>
                ...
                <div class="input-box">
                  ...
                  <input type="password" id="senha" name="senha" value="${cliente.senha}" readonly ><br><br>
                </div>
                <div class="input-box">
